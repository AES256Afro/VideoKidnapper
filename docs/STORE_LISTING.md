...
Canonical marketing copy for the Microsoft Store, GitHub, and the
website. Keep these in sync when features change. Plain English, feature
first, no em dashes. Every line is something the app actually does.

---

## Microsoft Store

### Short description (Store field: "Description" summary / ~200 chars)

Grab a video from the web, trim it to the exact moment, add captions, and export a clean GIF or MP4. Everything runs on your PC. No watermark, no account, no upload.

### Description (Store field: "Description" body)

Paste in the body of the Store listing's Description field:
...
Grab a video from the web, cut the part you want, caption it, and export a GIF or MP4. No watermark, no account, no upload.
